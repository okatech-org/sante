...
export default function SogaraEmployees() {
  ...
  const initialEmployees: Employee[] = [
    ...
    },
    {
      ...
      statut: "actif",
      derniereVisite: "2024-09-10",
      prochainExamen: "2025-03-10",
      phone: "+241 06 02 03 04",
      email: "i.tchen@sante.ga",
      ayantsDroit: 2,
      dossierComplet: true
    },
    {
      ...
      dateEmbauche: "2011-05-10",
      statut: "actif",
      derniereVisite: "2024-08-22",
      prochainExamen: "2025-02-22",
      phone: "+241 06 03 04 05",
      email: "e.avaro@sante.ga",
      ayantsDroit: 4,
      dossierComplet: true
    },
    {
      ...
      dateEmbauche: "2013-07-01",
      statut: "actif",
      derniereVisite: "2024-11-05",
      prochainExamen: "2025-05-05",
      phone: "+241 06 04 05 06",
      email: "l.bourdes@sante.ga",
      ayantsDroit: 1,
      dossierComplet: true
    },
    {
      ...
      dateEmbauche: "2014-02-15",
      statut: "actif",
      derniereVisite: "2024-10-01",
      prochainExamen: "2025-04-01",
      phone: "+241 06 05 06 07",
      email: "l.ditsougou@sante.ga",
      ayantsDroit: 2,
      dossierComplet: true
    },
    {
      id: "EMP-SOGARA-0006",
      nom: "Pierrette NOMSI",
      poste: "Infirmière Cheffe",
      departement: "Médical",
      dateEmbauche: "2015-09-10",
      statut: "actif",
      derniereVisite: "2024-11-12",
      prochainExamen: "2025-05-12",
      phone: "+241 06 06 07 08",
      email: "p.nomsi@sante.ga",
      ayantsDroit: 1,
      dossierComplet: true
    },
    {
    ...
    },
    {
      ...
      dateEmbauche: "2017-11-20",
      statut: "actif",
      derniereVisite: "2024-07-15",
      prochainExamen: "2025-01-15",
      phone: "+241 06 08 09 10",
      email: "p.bekale@sante.ga",
      ayantsDroit: 2,
