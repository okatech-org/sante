...
function generateEstablishments(): CartographyProvider[] {
  ...
  for (let i = 1; i <= 147; i++) {
    ...
    establishments.push({
      ...
      province: getProvinceForCity(selectedCity),
      ville: selectedCity,
      adresse: `Rue ${i}, Quartier ${Math.ceil(i/10)}`,
  ...
  for (let i = 1; i <= 114; i++) {
    ...
    establishments.push({
      ...
      province: getProvinceForCity(selectedCity),
      ville: selectedCity,
      adresse: `Boulevard ${i}, Zone commerciale`,
  ...
  for (let i = 1; i <= 46; i++) {
    ...
    establishments.push({
      ...
      province: getProvinceForCity(selectedCity),
      ville: selectedCity,
      adresse: `Immeuble ${i}, Etage ${(i % 4) + 1}`,
  ...
  for (let i = 1; i <= 16; i++) {
    ...
    establishments.push({
      ...
      province: "Estuaire",
      ville: selectedCity,
      adresse: `Boulevard Administratif ${i}`,
