-- ============================================
-- SEMAINE 1 - Fonctions RPC optimisées
-- ============================================

-- 1. Fonction pour récupérer le contexte complet d'un professionnel dans un établissement
...
-- 2. Fonction pour récupérer tous les établissements d'un professionnel
...
Utilisé par MultiEstablishmentContext pour charger le contexte actif.';
...
Utilisé pour la page de sélection d''établissement.';

COMMENT ON FUNCTION public.has_permission IS 
'Vérifie si un utilisateur a une permission spécifique dans un établissement.
Supporte les permissions individuelles et la permission "all" (admin complet).';